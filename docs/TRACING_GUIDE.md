...
本文档介绍如何在 github.com/alldev-run/golang-gin-rpc 项目中使用分布式链路追踪功能。
...
| 参数 | 说明 | 默认值 |
|------|------|--------|
| `service_name` | 服务名称 | `github.com/alldev-run/golang-gin-rpc` |
...
```go
import "github.com/alldev-run/golang-gin-rpc/pkg/tracing"
