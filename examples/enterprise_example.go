...
func (app *EnterpriseApplication) initializeComponents() error {
	...
	app.metrics = metrics.GetGlobalMetrics()
...
func (app *EnterpriseApplication) registerHealthCheckers() {
	...
	dbChecker := health.NewDatabaseHealthChecker("database", app.dbPool.GetDB())
...
func (app *EnterpriseApplication) SetupRoutes() *gin.Engine {
	...
	r.GET("/health", app.healthManager.HTTPHandler())
	...
	// Metrics endpoint
	r.GET("/metrics", app.metrics.MetricsHandler())
...
func (app *EnterpriseApplication) getUsers(c *gin.Context) {
	...
	app.metrics.RecordBusinessOperation("get_users", "success")
...
func (app *EnterpriseApplication) createUser(c *gin.Context) {
	...
	app.metrics.RecordBusinessOperation("create_user", "success")
...
func (app *EnterpriseApplication) setCacheValue(c *gin.Context) {
	...
	app.metrics.RecordBusinessOperation("set_cache", "success")
	c.JSON(http.StatusOK, gin.H{
